...
| **Description** | Introducing hybrid crypto types which support both classical and quantum signatures |
| **Authors**     | Jeff Burdges, Elizabeth Crites, Syed Hosseini                                       |

## Summary

We propose new crypto types consisting of pair of a classical and a quantum resistant keys (Falcon), the signature verification could be carried out by verifying either of the keys. The verification of the classical signature could optionally be disabled after migration to 
